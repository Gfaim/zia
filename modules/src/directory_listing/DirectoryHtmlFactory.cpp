...
std::string DirectoryHtmlFactory::GetFileIcon(const std::string &name, const std::string &ext)
{
    ...
    static const std::map<std::string, std::string> file_icon_ext_map{
        ...
        {".json", "https://cdn-icons-png.flaticon.com/512/6577/6577214.png"},
        {".yaml", "https://cdn-icons-png.flaticon.com/512/6577/6577214.png"},
        {".yml", "https://cdn-icons-png.flaticon.com/512/6577/6577214.png"},
